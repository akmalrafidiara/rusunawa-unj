...
$staffrusunawaSidebarMenu = [
    [
        ...
        'items' => [
            [
                'icon' => 'home',
                'label' => __('Overview'),
                'route' => route('staff_of_rusunawa.dashboard'),
                'current' => request()->routeIs('staff_of_rusunawa.dashboard'),
                'badge' => null,
            ],
        ],
    ],
    ...
    // Menu untuk pengelolaan penyewaan unit rusunawa
    [
        'group' => 'Penyewaan',
        'items' => [
            [
    ...
    // Menu untuk operasional harian rusunawa
    [
        'group' => 'Oprasional',
        'items' => [
            [
            ...
            // Submenu untuk manajemen unit dan tipe unit
            [
                'expandable' => true,
    ...
    // Menu untuk pengelolaan konten website
    [
        'group' => 'Manajemen Konten',
        'items' => [
            // Submenu untuk halaman beranda
            [
                'expandable' => true,
                'label' => __('Beranda'),
                'items' => [
...
<flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 w-full">
    ...
    <a href="{{ route('staff_of_rusunawa.dashboard') }}" class="me-5 flex items-center space-x-2 rtl:space-x-reverse" wire:navigate.hover>
        <x-default.app-logo />
    </a>

    {{-- Dynamic Sidebar Menu --}}
    <flux:navlist variant="outline" class="space-y-4">
        @foreach ($staffrusunawaSidebarMenu as $menu)
    ...
    <flux:dropdown position="bottom" align="start">
        ...
        <flux:menu class="w-[220px]">
            ...
            <flux:menu.radio.group>
                <flux:menu.item :href="route('staff-of-rusunawa.settings.profile')" icon="cog" wire:navigate.hover>
                    {{ __('Pengaturan Akun') }}
                </flux:menu.item>
            </flux:menu.radio.group>
