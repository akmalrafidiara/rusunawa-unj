    ...
    [
        ...
        'items' => [
            [
                'icon' => 'home',
                'label' => __('Overview'),
                'route' => route('head_of_rusunawa.dashboard'),
                'current' => request()->routeIs('head_of_rusunawa.dashboard'),
                'badge' => null,
            ],
        ],
    ],
...
<flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900 w-full">
    ...
    <a href="{{ route('head_of_rusunawa.dashboard') }}" class="me-5 flex items-center space-x-2 rtl:space-x-reverse" wire:navigate.hover>
        <x-default.app-logo />
    </a>

    {{-- Dynamic Sidebar Menu --}}
    <flux:navlist variant="outline" class="space-y-4">
        @foreach ($headrusunawaSidebarMenu as $menu)
    ...
    <flux:dropdown position="bottom" align="start">
        ...
        <flux:menu class="w-[220px]">
            ...
            <flux:menu.radio.group>
                <flux:menu.item :href="route('head-of-rusunawa.settings.profile')" icon="cog" wire:navigate.hover>
                    {{ __('Pengaturan Akun') }}
                </flux:menu.item>
            </flux:menu.radio.group>
