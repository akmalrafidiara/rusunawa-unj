...
new #[Layout('components.layouts.staff-of-rusunawa')] class extends Component {
...
<section class="w-full">
    ...
    <x-staff-of-rusunawa.settings.layout :heading="__('Perbarui Kata Sandi')" :subheading="__('Pastikan akun Anda menggunakan kata sandi yang panjang dan acak untuk tetap aman.')">
    ...
    </x-staff-of-rusunawa.settings.layout>
</section>
