            ...
            <div class="space-y-3">
                <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-zinc-700">
                    ...
                    <span class="font-semibold text-gray-900 dark:text-white text-lg">
                        Kamar {{ \App\Models\Unit::find($recordUnitId)->room_number ?? 'N/A' }} - {{ \App\Models\Unit::find($recordUnitId)->unitCluster?->name ?? 'Tidak Diketahui' }}
                    </span>
                </div>
                <div class="flex justify-between items-center py-2 border-b border-gray-100 dark:border-zinc-700">
                ...
                @if ($recordType === \App\Enums\MaintenanceRecordType::ROUTINE->value)
                    ...
                    <div class="flex justify-between items-center py-2">
                        ...
                        @php
                            ...
                            $statusColor = $recordStatusEnum ? $recordStatusEnum->color() : ['bg-gray-100', 'text-gray-800', 'dark:bg-gray-700/30', 'dark:text-gray-400'];
