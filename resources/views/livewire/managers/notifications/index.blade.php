<div class="relative" x-data="{ open: false }" wire:poll.5s>
    <button @click="open = !open" class="relative text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:hover:text-white focus:outline-none">
    ...
    <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-80 bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-lg shadow-lg z-20">
        ...
        <div class="max-h-96 overflow-y-auto">
            @forelse($notifications as $notification)
                <div class="block p-4 border-b border-gray-100 dark:border-zinc-700 hover:bg-gray-100 dark:hover:bg-zinc-700 {{ is_null($notification->read_at) ? '' : '' }}">
                    <a 
                        href="#" 
