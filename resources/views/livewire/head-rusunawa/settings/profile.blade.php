...
<section class="w-full">
    ...
    <x-head-of-rusunawa.settings.layout :heading="__('Profil')" :subheading="__('Perbarui nama dan alamat email Anda')">
        ...
        <livewire:head-rusunawa.settings.delete-user-form />
