...
<section class="w-full">
    ...
    <x-head-of-rusunawa.settings.layout :heading="__('Perbarui Kata Sandi')" :subheading="__('Pastikan akun Anda menggunakan kata sandi yang panjang dan acak untuk tetap aman.')">
