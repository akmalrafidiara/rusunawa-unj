...
<section class="container mx-auto px-4 py-2 md:py-6 relative overflow-hidden">
    <div class="relative w-full py-0 px-4 sm:px-6 lg:px-8 mb-6 mt-6 overflow-hidden">
        ...
        <h1 class="text-3xl font-bold mb-8 hidden md:block dark:text-gray-100">Detail Pengaduan #{{ $report->unique_id }}
        </h1>
            ...
            <x-frontend.complaint.card class="p-6">
                <div class="space-y-2 text-gray-700 dark:text-gray-300 mb-6">
                    <div class="flex justify-between items-center">
                        ...
                        <span
                            class="px-2 py-1 rounded-full text-xs {{ implode(' ', $report->status->color()) }}">{{ $report->status->label() }}</span>
                    </div>
                    <div class="flex justify-between items-center">
        ...
        <div class="mb-6">
            <x-frontend.complaint.card class="p-6">
                ...
                @php
                    $imageAttachments = $report->attachments->filter(
