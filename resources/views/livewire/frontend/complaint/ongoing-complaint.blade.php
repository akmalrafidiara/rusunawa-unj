...
<section class="w-full">
    ...
    <div class="container mx-auto relative overflow-hidden -mt-32 md:-mt-25 lg:-mt-25">
        <x-frontend.complaint.layout>
            <h1 class="text-3xl font-bold mb-8 hidden md:block dark:text-gray-100">Pengaduan Berjalan</h1>

            @if ($isLoggedIn)
            {{-- Buat Riwayat Pengaduan Berjalan --}}
            @else
            ...
            <div class="flex flex-col items-center justify-center min-h-[400px] p-8 text-center">
                ...
                <h2 class="text-xl lg:text-2xl font-semibold text-gray-800 mb-2 dark:text-gray-100">Pengaduan Berjalan Tidak Tersedia</h2>
                <p class="text-m lg:text-lg text-gray-600 mb-6 dark:text-gray-300">Mohon Login terlebih dahulu untuk melihat pengaduan berjalan</p>
