...
<html lang="id">
    ...
    <head>
        ...
        <title>Verifikasi Penghuni Disetujui</title>
        <style>
            body {
                        ...
                        <tr>
                            <td style="padding: 30px 40px; color: #333333;">
                                <h1 style="font-size: 24px; color: #059669; margin-top: 0; font-weight: 600;">
                                    Selamat, Verifikasi Penghuni Anda Telah Disetujui! 🎉
                                </h1>
                                <p style="font-size: 16px; line-height: 1.6; color: #4a5568;">
                                    Halo <strong>{{ $occupant->full_name }}</strong>,
                                </p>
                                <p style="font-size: 16px; line-height: 1.6; color: #4a5568;">
                                    Verifikasi data penghuni Anda untuk unit {{ $contract->unit->room_number }}
                                    ({{ $contract->unit->unitType->name }}) telah berhasil disetujui.
                                </p>
                                <p style="font-size: 16px; line-height: 1.6; color: #4a5568;">
                                    Sekarang Anda dapat melanjutkan ke proses selanjutnya. Terima kasih atas kerja sama
                                    Anda.
                                </p>
