...
<html lang="id">
    ...
    <head>
        ...
        <title>Verifikasi Penghuni Ditolak</title>
        <style>
            body {
                        ...
                        <tr>
                            <td style="padding: 30px 40px; color: #333333;">
                                <h1 style="font-size: 24px; color: #dc3545; margin-top: 0; font-weight: 600;">
                                    Mohon Maaf, Verifikasi Penghuni Anda Ditolak
                                </h1>
                                ...
                                <p style="font-size: 16px; line-height: 1.6; color: #4a5568;">
                                    ...
                                    ({{ $contract->unit->unitType->name }}) telah ditolak.
                                </p>
                                <p style="font-size: 16px; line-height: 1.6; color: #4a5568;">
                                    Mohon periksa kembali dokumen atau informasi yang Anda berikan dan coba lagi, atau
