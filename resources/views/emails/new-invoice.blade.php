...
<html lang="id">
    ...
    <head>
        ...
        <title>Tagihan Baru Rusunawa UNJ - #{{ $invoice->invoice_number }}</title>
        <style>
            body {
                    ...
                    <table class="container" width="100%" border="0" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td style="padding: 30px 40px; color: #333333;">
                                <h1 style="font-size: 24px; color: #1a202c; margin-top: 0; font-weight: 600;">
                                    Halo {{ $occupantName }}, Anda Memiliki Tagihan Baru!
                                </h1>
                                <p style="font-size: 16px; line-height: 1.6; color: #4a5568;">
                                    Tagihan perpanjangan sewa bulanan untuk unit <strong
                                        style="font-size: 18px;">{{ $unitCluster }} | {{ $unitNumber }}</strong>
                                    telah
                                    berhasil dibuat.
                                </p>
                                ...
                                <h2
                                    style="font-size: 20px; color: #059669; border-top: 1px solid #eeeeee; padding-top: 25px; margin-top: 25px; font-weight: 600;">
                                    Instruksi Pembayaran</h2>
                                <p style="font-size: 16px; line-height: 1.6; color: #4a5568;">
                                    Silakan lakukan pembayaran melalui detail rekening berikut:
                                </p>
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="margin: 20px 0;">
                                    <tr>
                                        <td style="padding: 20px; background-color: #f9fafb; border-radius: 8px;">
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td style="padding: 5px 0; font-size: 15px; color: #4a5568;">
                                                        Nomor Virtual Account</td>
                                                    <td
                                                        style="padding: 5px 0; font-size: 16px; color: #1a202c; text-align: right; font-weight: 600;">
                                                        <code
                                                            style="background-color: #e5e7eb; padding: 3px 6px; border-radius: 4px; letter-spacing: 2px;">
                                                            {{ chunk_split($invoice->contract->unit->virtual_account_number, 4, ' ') }}
                                                        </code>
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <p style="font-size: 16px; line-height: 1.6; color: #4a5568;">
                                    Untuk melihat detail tagihan lengkap dan mengunggah bukti pembayaran, silakan masuk
                                    ke dashboard Anda:
                                </p>
                                <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    style="margin: 25px 0;">
                        ...
                        <tr>
                            <td
                                ...
                                <p style="margin: 0;">Anda menerima email ini karena memiliki tagihan di Sistem Rusunawa
                                    UNJ.</p>
